                                 ...
                                 <div class="row p-2 p-lg-4">
                                    ...
                                    <div class="col-lg-3 col-12 mb-4 mb-lg-0">
                                       <div class="card border-0">
                                          <img src="{{ asset('frontend') }}/assets/images/banner/menu-banner.jpg" alt="eCommerce HTML Template" class="img-fluid" />
               ...
               <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item py-3 ps-0 border-top">
                     ...
                     <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                           <div class="d-flex">
                              <img src="{{ asset('frontend') }}/assets/images/products/product-img-1.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
                              <div class="ms-3">
                                 <!-- title -->
                  ...
                  <li class="list-group-item py-3 ps-0">
                     ...
                     <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                           <div class="d-flex">
                              <img src="{{ asset('frontend') }}/assets/images/products/product-img-2.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
                              <div class="ms-3">
                                 <a href="pages/shop-single.html" class="text-inherit">
                  ...
                  <li class="list-group-item py-3 ps-0">
                     ...
                     <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                           <div class="d-flex">
                              <img src="{{ asset('frontend') }}/assets/images/products/product-img-3.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
                              <div class="ms-3">
                                 <!-- title -->
                                 <a href="pages/shop-single.html" class="text-inherit">
                  ...
                  <li class="list-group-item py-3 ps-0">
                     ...
                     <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                           <div class="d-flex">
                              <img src="{{ asset('frontend') }}/assets/images/products/product-img-4.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
                              <div class="ms-3">
                                 <!-- title -->
                                 <!-- title -->
                                 <a href="pages/shop-single.html" class="text-inherit">
                  ...
                  <li class="list-group-item py-3 ps-0 border-bottom">
                     ...
                     <div class="row align-items-center">
                        <div class="col-6 col-md-6 col-lg-7">
                           <div class="d-flex">
                              <img src="{{ asset('frontend') }}/assets/images/products/product-img-5.jpg" alt="Ecommerce" class="icon-shape icon-xxl" />
                              <div class="ms-3">
                                 <!-- title -->
                                 <a href="pages/shop-single.html" class="text-inherit">
